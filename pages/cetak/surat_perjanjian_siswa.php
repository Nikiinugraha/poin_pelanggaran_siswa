...
if(isset($_GET['nis'])){
    ...
    while($id_pelanggaran_siswa = mysqli_fetch_assoc($pelanggaran_siswa)){
        ...
        if(mysqli_num_rows($cek_data) == 0){
            echo "<script>alert('Siswa melakukan pelanggaran baru, silahkan cetak surat lagi, dengan memilih nis " . $nis . "'); window.location.href = '/poin_pelanggaran_siswa/pages/cetak/add_perjanjian_siswa.php';</script>";
            exit;
        }
    }
    ...
    if(mysqli_num_rows(mysqli_query($conn, "SELECT * FROM pelanggaran_siswa WHERE nis = '$nis'")) == 0){
        echo "<script>alert('Data siswa belum memiliki data pelanggaran 👍'); window.location.href = '/poin_pelanggaran_siswa/pages/cetak/add_perjanjian_siswa.php';</script>";
        exit;
    }
...
<!-- link css -->
<link rel="stylesheet" href="/poin_pelanggaran_siswa/css/pages/cetak/surat_perjanjian_siswa.css">
...
<center class="no-print">
    ...
    <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
        ...
        if(isset($_GET['nis'])){
        ?>
            <form action="/poin_pelanggaran_siswa/pages/laporan/list_perjanjian.php?from=list_perjanjian.php" style="margin: 0;">
                <button type="submit">
...
<div class="page">
    <!-- Header -->
    <div class="header">
        <!-- menampilkan gambar kop surat dari folder assets/images-->
...
<!-- Bungkus footer dengan no-print agar tidak memicu munculnya lembar kosong kedua -->
<div class="no-print">
    <?php 
    // Menyertakan bagian footer (penutup halaman)
